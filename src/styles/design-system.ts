...
export const typography = {
  ...
  fontSize: {
    ...
    'display-medium': [
      '2.8125rem',
      { lineHeight: '3.25rem', letterSpacing: '-0.01em', fontWeight: '400' },
    ],
    'display-small': [
      '2.25rem',
      { lineHeight: '2.75rem', letterSpacing: '0em', fontWeight: '400' },
    ],

    'headline-large': [
      '2rem',
      { lineHeight: '2.5rem', letterSpacing: '0em', fontWeight: '600' },
    ],
    'headline-medium': [
      '1.75rem',
      { lineHeight: '2.25rem', letterSpacing: '0em', fontWeight: '600' },
    ],
    'headline-small': [
      '1.5rem',
      { lineHeight: '2rem', letterSpacing: '0em', fontWeight: '600' },
    ],
    ...
    'body-small': [
      '0.75rem',
      { lineHeight: '1rem', letterSpacing: '0.04em', fontWeight: '400' },
    ],
  },
} as const;
