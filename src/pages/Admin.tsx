...
const AdminConsole: React.FC = () => {
  ...
  const panels = [
    {
      ...
      name: 'Users & Roles',
      icon: '👥',
      requiredRoles: ['superadmin', 'admin', 'support'],
    },
    {
      id: 'waitlist' as AdminPanel,
      name: 'Waitlist',
      icon: '📋',
      requiredRoles: ['superadmin', 'admin', 'support'],
    },
    {
      id: 'flags' as AdminPanel,
      name: 'Feature Flags',
      icon: '🚀',
      requiredRoles: ['superadmin', 'admin'],
    },
    {
      id: 'audit' as AdminPanel,
      name: 'Audit Logs',
      icon: '📊',
      requiredRoles: ['superadmin', 'admin', 'support'],
    },
  ...
  const availablePanels = panels.filter(panel =>
    user?.hasRole(panel.requiredRoles as UserRole[])
  );
        ...
        <div className='max-w-7xl mx-auto px-6 py-4'>
          <div className='flex justify-between items-center'>
            <div className='flex items-center space-x-4'>
              ...
              <div>
                <h1 className='text-headline-medium font-semibold text-neutral-900'>
                  Calendado Admin
                </h1>
            ...
            <nav className='space-y-3'>
              {availablePanels.map(panel => (
                ...
                >
                  ...
                  <div>
                    <div className='font-semibold text-title-medium'>
                      {panel.name}
                    </div>
                    <div
