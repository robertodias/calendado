              ...
              <div className='text-left max-w-2xl mx-auto space-y-4'>
                <div className='flex items-start space-x-3'>
                  ...
                  <div>
                    ...
                    <p className='text-gray-600'>
                      Start with the brand page, then navigate to store and
                      professional pages.
                    </p>
                  </div>
                </div>
                <div className='flex items-start space-x-3'>
                  ...
                  <div>
                    ...
                    <p className='text-gray-600'>
                      Select a service and time slot, then click "Book with
                      [Professional]" to start the booking wizard.
                    </p>
                  </div>
                </div>
                <div className='flex items-start space-x-3'>
                  ...
                  <div>
                    ...
                    <p className='text-gray-600'>
                      Use the "Booking with Preselection" route to test URL
                      parameter handling.
                    </p>
                  </div>
                </div>
                <div className='flex items-start space-x-3'>
                  ...
                  <div>
                    ...
                    <p className='text-gray-600'>
                      Fill out the customer form and confirm the booking to see
                      the success page.
                    </p>
                  </div>
                </div>
