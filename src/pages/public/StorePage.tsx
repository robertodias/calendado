...
const StorePage: React.FC = () => {
  const { brandSlug, storeSlug } = useParams<{ brandSlug: string; storeSlug: string }>();
  ...
  const filteredProfessionals = [
    ...
    const matchesService = selectedService === 'all' || pro.services.some(service => 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
            ...
            <div className="lg:col-span-2">
              <Card className="p-6">
                <h2 className="text-xl font-semibold text-neutral-900 mb-4">Store Information</h2>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-neutral-600">Rua da Independência, 123<br />Porto Alegre, RS - Brazil</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-neutral-600">Mon-Fri: 9:00-18:00<br />Sat: 9:00-17:00</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-neutral-600">porto-alegre@glow.com.br</p>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="space-y-6">
              <Card className="p-6">
                <h3 className="text-lg font-semibold text-neutral-900 mb-4">Store Stats</h3>
                  ...
                  <div className="flex items-center space-x-4 mb-4">
                    <div className="flex-shrink-0">
                      <div className="h-12 w-12 bg-primary-100 rounded-full flex items-center justify-center">
                        <span className="text-primary-600 font-semibold">{pro.avatar}</span>
                      </div>
                    </div>
                    <div className="flex-1 min-w-0">
                      <h3 className="text-lg font-semibold text-neutral-900">{pro.name}</h3>
          ...
          {/* Services */}
          <div className="mb-8">
            <h2 className="text-2xl font-bold text-neutral-900 mb-6">Available Services</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              {[
                ...
                <Card key={service} className="p-4 text-center hover:shadow-md transition-shadow">
