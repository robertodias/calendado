        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8'>
          ...
          <div className='mb-8'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
              ...
              <Card
                ...
                onClick={() => handleStoreClick('porto-alegre')}
              >
              ...
              <Card
                className='p-6 hover:shadow-lg transition-shadow cursor-pointer'
                onClick={() => handleStoreClick('centro')}
              >
                <div className='flex items-center justify-between mb-4'>
                  <h3 className='text-lg font-semibold text-neutral-900'>
                    Centro
              ...
              <Card
                className='p-6 hover:shadow-lg transition-shadow cursor-pointer'
                onClick={() => handleStoreClick('zona-sul')}
              >
                <div className='flex items-center justify-between mb-4'>
                  <h3 className='text-lg font-semibold text-neutral-900'>
                    Zona Sul
          ...
          <div className='mb-8'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
              ...
              <Card
                className='p-6 hover:shadow-lg transition-shadow cursor-pointer'
                onClick={() => handleProClick('porto-alegre', 'maria-silva')}
              >
              ...
              <Card
                className='p-6 hover:shadow-lg transition-shadow cursor-pointer'
                onClick={() => handleProClick('centro', 'joao-pereira')}
              >
                <div className='flex items-center space-x-4 mb-4'>
                  <div className='flex-shrink-0'>
                    <div className='h-12 w-12 bg-primary-100 rounded-full flex items-center justify-center'>
              ...
              <Card
                className='p-6 hover:shadow-lg transition-shadow cursor-pointer'
                onClick={() => handleProClick('zona-sul', 'ana-lima')}
              >
                <div className='flex items-center space-x-4 mb-4'>
                  <div className='flex-shrink-0'>
                    <div className='h-12 w-12 bg-primary-100 rounded-full flex items-center justify-center'>
