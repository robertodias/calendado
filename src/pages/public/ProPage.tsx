...
import { storeUrl, brandUrl, soloProUrl, proUrl } from '../../lib/buildPublicUrl';
...
const ProPage: React.FC = () => {
  ...
  const mockServices = [
    ...
    { id: 'hair-color', name: 'Hair Color', duration: '120 min', price: '$120' },
    { id: 'hair-styling', name: 'Hair Styling', duration: '90 min', price: '$80' },
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-neutral-50 to-neutral-100 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-neutral-600">Loading professional information...</p>
        </div>
      </div>
    );
  }
  ...
  // Error states
  if (error === 'not_found') {
    return <PublicNotFound path={isSoloPro ? `/u/${proSlug}` : `/${brandSlug}/${storeSlug}/${proSlug}`} />;
  }
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              {/* Reviews */}
              <Card className="p-6">
                <h2 className="text-xl font-semibold text-neutral-900 mb-4">Reviews</h2>
                  ...
                  {[
                    {
                      name: 'Sarah Johnson',
                      rating: 5,
                      comment: 'Excellent service! Maria is very professional and skilled.',
                      date: '2024-01-10'
                    },
                    {
                      name: 'Mike Chen',
                      rating: 5,
                      comment: 'Great haircut and friendly service. Highly recommended!',
                      date: '2024-01-08'
                    },
                    {
                      name: 'Emily Davis',
            ...
            <div className="space-y-6">
              {/* Professional Stats */}
              <Card className="p-6">
                <h3 className="text-lg font-semibold text-neutral-900 mb-4">Professional Stats</h3>
                ...
                <div className="space-y-3">
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">
                      {selectedService ? mockServices.find(s => s.id === selectedService)?.name : 'Select service'}
                    </span>
                  </div>
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">
                      {selectedService ? mockServices.find(s => s.id === selectedService)?.duration : 'N/A'}
                    </span>
                  </div>
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">
                      {selectedService ? mockServices.find(s => s.id === selectedService)?.price : 'N/A'}
                    </span>
                  </div>
                </div>
