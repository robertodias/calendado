...
import { getProfessionalBySlug, getBrandBySlug, getStoreBySlug } from '../../lib/bookingMockData';
...
const ProPage: React.FC = () => {
  ...
  const handleBookingConfirm = () => {
    ...
    console.log('Booking confirmed! This is a demo - in production, this would complete the booking.');
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <Button onClick={() => navigate(isSoloPro ? '/' : `/${brandSlug}/${storeSlug}`)}>
          ...
          <div className="flex items-start space-x-6">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center space-x-3 mb-2">
                <h1 className="text-3xl font-bold text-gray-900">{professional.displayName}</h1>
                {professional.role && (
              ...
              {professional.bio && (
                <p className="text-gray-600 mb-4 max-w-2xl">{professional.bio}</p>
              )}
            ...
            <Button
              variant="outline"
              onClick={() => navigate(isSoloPro ? '/' : `/${brandSlug}/${storeSlug}`)}
            >
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <p className="text-gray-600 mb-4">
                  Select a service and choose your preferred date and time to continue.
                </p>
                <div className="flex items-center justify-center space-x-6 text-sm text-gray-500">
                  <div className="flex items-center space-x-2">
                    <div className={`w-3 h-3 rounded-full ${selectedService ? 'bg-green-500' : 'bg-gray-300'}`}></div>
                    <span>Select Service</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <div className={`w-3 h-3 rounded-full ${selectedDate && selectedTime ? 'bg-green-500' : 'bg-gray-300'}`}></div>
