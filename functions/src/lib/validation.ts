 ...
 */
export function validateUtmData(utm: unknown): ValidationResult {
  const errors: string[] = [];
  ...
  const utmObj = utm as Record<string, unknown>;
 ...
 */
export function validateWaitlistData(data: unknown): ValidationResult {
  const errors: string[] = [];
  ...
  const waitlistData = data as Record<string, unknown>;
